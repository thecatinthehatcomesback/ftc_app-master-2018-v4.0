...
public class CatVisionHardware
{
    ...
    /* Constructor */
    public CatVisionHardware(){

    }


    /* Initialize standard Hardware interfaces */
    public void initDogeforia(HardwareMap hardwareMap, LinearOpMode newOpMode) {
    ...
    public samplingPos findGoldPos() {
        if (detector.isFound()) {
            if (detector.getXPosition() > 480) {
                opMode.telemetry.addData("Pos:", "Right");
                return samplingPos.RIGHT;
            } else if (detector.getXPosition() < 170) {
                opMode.telemetry.addData("Pos:", "Left");
                return samplingPos.LEFT;
            } else {
                opMode.telemetry.addData("Pos:", "Center");
